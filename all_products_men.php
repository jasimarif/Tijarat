    ...
    <div id="contents">
      ...
      <div id="product_box"  class="" style="margin-top:60px;background-color:white" >
          <div class="container-flex">
             <div class="col-sm-12" style="margin-left:3%;">
              <div class="row">
                    ...
                    <?php 
                    $get_pro= "SELECT * FROM products WHERE product_cat=1";
         ...
         while($row_pro=mysqli_fetch_array($run_pro))
         {
            ...
            <p> PKR $pro_price </p>
            <a href='all_products_men.php?add_cart=$pro_id'> <button class='btn btn-sm mx-4 btn-primary' style:'float:right'> Add to cart </button> </a>     
